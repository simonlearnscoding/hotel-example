    ...
    <footer className="bg-stone-900 " aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div className="space-y-8">
            ...
            <div className="flex space-x-6">
              { navigation.social.map( ( item ) => (
                <a key={ item.name } href={ item.href } className="text-gray-100 hover:text-gray-100">
              ...
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  { navigation.solutions.map( ( item ) => (
                    <li key={ item.name }>
                      <a href={ item.href } className="text-sm leading-6 text-gray-100 hover:text-gray-100">
                        { item.name }
                      </a>
                    </li>
                  ) ) }
        ...
        <div className="mt-16 border-t border-gray-100/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-100">&copy; 2020 Your Company, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
